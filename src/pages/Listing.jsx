                ...
                <SwiperSlide key={index}>
                    ...
                    style={{
                        background:`url(${listing.imgUrls[index]})
                         center no repeat`,backgroundSize:'cover'}} className='swiperSlideDiv'>
                    <img src={listing.imgUrls[index]} style={{objectFit:'cover',maxHeight:'40vh',width:'100%'}} />
                    </div>
                </SwiperSlide>
            ))}
        </Swiper>
        ...
        <div className='listingDetails' >
            ...
            {auth.currentUser.uid !== listing.userRef && (
                <Link to={`/contact/${listing.userRef}?listingName=${listing.name}`}
                    className='primaryButton'>Contact
                </Link>
            )}
        </div>
    </main>
